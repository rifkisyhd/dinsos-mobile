...
import { View, Text, TouchableOpacity, Image, SafeAreaView, ScrollView, Linking } from 'react-native';
      ...
      <ScrollView style={styles.scrollView}>
        <View style={styles.contentContainer}>
          ...
          <View style={styles.titleSection}>
            <Text style={styles.mainTitle}>Sampaikan Aspirasi dan Pengaduan</Text>
            <Text style={styles.subtitle}>Demi Pelayanan Publik Yang Lebih Baik</Text>
          </View>
          ...
          <View style={styles.downloadSection}>
            <Text style={styles.downloadTitle}>Download Aplikasinya Di Playstore!</Text>
